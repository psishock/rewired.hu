...
?>
 ...
 <?php
 /*
 $ujkomment = advanced_forum_reply_num_new($nid);
 print $ujkomment;
 */
  ?>
      ...
      <table class="forum-table forum-table-forums">
        <thead class="forum-header">
          <tr>
            ...
            <th class="forum-name"><?php print t('Fórum'); ?></th>
            <th class="forum-topics"><?php print t('Szálak'); ?></th>
            <th class="forum-posts"><?php print t('Válasz'); ?></th>
            <th class="forum-last-post"><?php print t('Utolsó Hozzászólás'); ?></th>
          </tr>
        </thead>
            ...
            <?php if ($item->is_container): ?>
              ...
              <td class="forum-details" colspan="<?php print $colspan ?>">
			   ...
			   <?php if ($item->new_posts): ?>
				<div class="forum-markasread"> 
					<a href="/forum/markasread/<?php print $item->tid ?>" title="<?php print $item->name; ?> fórumon belüli összes topik megjelölése olvasottként" >Láttam</a>
				</div>
			   <?php endif; ?>
                </div>
                ...
                <td class="forum-number-topics">
                  <div class="forum-number-topics"><?php print $item->total_topics ?>
                    ...
                    <?php if ($item->new_topics): ?>
                      <div class="forum-number-new-topics"></div>
