...
<div id="<?php print $post_id; ?>" class="<?php print $classes; ?> <?php print $zebra ?>" <?php print $attributes; ?>>
  <div class="forum-post-info clearfix"> 
      <div class="forum-posted-on">
      <?php print $permalink . " - " . $date; ?>
    ...
    <?php endif; ?>
     ...
     <?php /* <span class="forum-post-number"><?php print $permalink; ?></span> */?>
...
<div class="forum-post-links"> 
  ...
  <div class="forum-post-wrapper <?php print $zebra ?>">
  <div class="forum-post-panel-sub <?php print $zebra ?>">
      <?php if (!empty($author_pane)): ?>
        <?php print $author_pane; ?>
      <?php endif; ?>
    </div>

    <div class="forum-post-panel-main clearfix <?php print $zebra ?>">
      <?php if (!empty($title)): ?>
        <div class="forum-post-title <?php print $zebra ?>">
          <?php print $title ?>
        </div>
      <?php endif; ?>

      <div class="forum-post-content <?php print $zebra ?>">
        <?php
  ...
  <?php /* <div class="forum-post-footer clearfix"> */?>
