...
<div class="author-pane">
	<div class="author-pane-inner">
		...
		<div class="author-pane-section author-pane-general">
			<?php global $authorPanelElrejtes; ?>
			...
			<div class="author-pane-line author-name">
				<b><?php print $account_name; ?> </b>
			</div>	  
	  
			<?php /* Posts */ ?>
			<?php if (isset($authorPanelElrejtes) && $authorPanelElrejtes == 0): ?> 
				<?php if (isset($user_stats_posts)): ?>
					<div class="author-pane-line author-posts">
						<span class="author-pane-label"><?php print t('Hozzászólások'); ?>:</span>
						<div class="author-pane-label-posts-value" style="float: right;"><?php print $user_stats_posts; ?></div>
					</div>
				<?php endif; ?>
			<?php endif; ?>
		</div>
		...
		<?php if (isset($authorPanelElrejtes) && $authorPanelElrejtes == 0): ?> 
			<?php if (isset($userpoints_points)): ?>
				<div class="author-pane-line author-points"> 
					<span class="author-pane-label"><?php print t('Perkek', userpoints_translation()); ?>:</span>
					<div class="author-pane-label-points-value" style="float: right;"><?php print $userpoints_points; ?></div>
				</div>
			<?php endif; ?>
		<?php endif; ?>
		...
		<!--		<span class="author-pane-label"><?php print t('Belépett'); ?>:</span>  -->
		<!--		<div class="author-pane-label-joined-value" style="float: right;"><?php print $joined; ?></div>  -->
		<!-- </div>  -->
		<!-- <?php endif; ?>  -->
		...
		<div class="author-pane-section author-pane-contact">
			...
			<?php /* Hozzaszolasok */ ?> 
			<?php if (isset($authorPanelElrejtes) && $authorPanelElrejtes == 0): ?> 
				<div class="author-pane-hozzaszolasok">
					<a href="<?php global $base_url; print $base_url;?>/user/<?php echo $account->uid;?>/hozzaszolasok">
						<img src="/sites/all/files/hozzaszolasok.png" border="0" alt="A felhasznaló hozzászólásainak listázása">
					</a> 
				</div>
			<?php endif; ?>
			...
			<?php /* Topikok */ ?>
			<?php if (isset($authorPanelElrejtes) && $authorPanelElrejtes == 0): ?> 
				<div class="author-pane-topikok">
					<a href="<?php global $base_url; print $base_url;?>/user/<?php echo $account->uid;?>/topikok">
						<img src="/sites/all/files/topikok.png" border="0" alt="A felhasznaló által nyitott topikok listázása">
					</a>
				</div>
			<?php endif; ?>
